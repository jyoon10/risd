...
function draw() {
  ...
  fill(75, 100, 100);
  rect(mouseX, mouseY+windowHeight/3, windowWidth, windowHeight/6);
//
// if (mouseY < 70) {
//   fill(75, 100, 100);
//   rect(mouseX, 70, windowWidth, windowHeight/6);
//   fill(75, 100, 100);
//   rect(mouseX, 70+windowHeight/3, windowWidth, windowHeight/6);
...
//   fill(75, 100, 100);
//   rect(mouseX, windowHeight/2.6+windowHeight/3, windowWidth, windowHeight/6);
// }
